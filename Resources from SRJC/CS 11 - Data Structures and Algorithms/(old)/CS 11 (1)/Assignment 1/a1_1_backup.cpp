...
void swapArray (int* arr[], int ref1, int ref2);
...
Questions 17 & 18:
The address of the First Element of array a is: 99
The address of the Second Element of array a is: 99
...
Question 23:   <--  I was unable to figure out this problem in time.
a[0] is: 99    <--  No matter what I tried, my swap function could not swap the array values.
a[1] is: 0     <--  I am assuming it is an error in my swap function.
*/
